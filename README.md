...
새로운 취미를 시작하고 싶을 때 여러 사람들과 정보를 공유하는 사이트를 만들고자 하는 목표를 가지고 개발한 개인 프로젝트입니다. <br>
게시판, 그룹 생성 및 가입, 메시지 주고 받기, 이벤트, 주소 검색 후 위치별 스팟 생성 및 가입 기능을 구현했고 꾸준하게 새로운 기능을 구상해 추가하고 있습니다.
