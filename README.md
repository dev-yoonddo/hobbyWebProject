...
### ⚙ 메인페이지로 이동하기 전 시작페이지
#### ① 아이콘 무한 롤링 배너, ② 텍스트 타이핑, ③ 로딩 아이콘 생성 후 5초 뒤 메인페이지로 이동

<br>

![startPage](https://user-images.githubusercontent.com/84071666/236172736-22cc53b4-392d-46d4-a38e-3ae005135f87.PNG)
