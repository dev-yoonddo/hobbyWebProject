...
<body id="header">
	...
	<div id="schedule-container">
		<h2><%=skedMonth%>/<%=skedDay%>&nbsp;&nbsp;New Schedule
		</h2>
		<div id="sked-form">
			<input type="text" placeholder="스케줄 내용을 입력하세요" name="skedContent"
				id="skedContent" class="intro" maxlength="100">
			<button type="button" class="btn-blue" id="sb" onclick="regist()">
				<span>등록하기</span>
			</button>
		</div>
	</div>
